...
var OFFLINE_FEEDBACK = [
  "\xA1Se ve que le echaste ganas! Sigue asi campe\xF3n \u{1F4AA}",
  "\xA1Buen trabajo! Tu mascota esta orgullosa de ti \u{1F31F}",
  "\xA1Wow, que cool! Estas aprendiendo muy rapido \u{1F680}",
  "\xA1Excelente esfuerzo! Cada dia mejoras mas \u2B50",
  "\xA1Tu mascota brinca de felicidad al ver tu trabajo! \u{1F389}",
  "\xA1Muy bien hecho! La practica hace al maestro \u{1F4DA}",
  "\xA1Increible! Sigue asi y seras un experto \u{1F3C6}",
  "\xA1A tu mascota le encanta que entrenes! \u{1F43E}"
];
...
function offlineResult() {
  const score = Math.floor(Math.random() * 31) + 50;
...
__name(offlineResult, "offlineResult");
...
// ../.wrangler/tmp/pages-NvqKe6/functionsRoutes-0.526126213620753.mjs
var routes = [
  {
